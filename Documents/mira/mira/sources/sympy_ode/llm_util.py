...
class CodeExecutionError(Exception):
    ...
    def run_multi_agent_pipeline(
        ...
        """Run multi-agent pipeline for ODE extraction and validation.
        ...
        Returns
        -------
        tuple[str, dict or None, dict]
            A tuple containing:
            - Validated ODE string
            - Concepts dictionary (or None if extraction failed)
    ...
    def extract_odes(
        ...
        """Extract ODEs from image using ODEExtractionSpecialist"""
    ...
    def concept_grounding(
        ...
        """Extract concepts from ODE string using ConceptGrounder"""
    ...
    def fix_execution_errors(
        ode_str: str,
        client: OpenAIClient,
    ) -> str:
        """Check and correct execution errors in ODE code."""
