...
susceptible_nyc, susceptible_boston = (
    susceptible.with_context(city=city) for city in cities
)
...
susceptible_nyc_to_boston = NaturalConversion(
    subject=susceptible_nyc, outcome=susceptible_boston
)
susceptible_boston_to_nyc = NaturalConversion(
    subject=susceptible_boston, outcome=susceptible_nyc
)
infected_nyc_to_boston = NaturalConversion(
    subject=infected_nyc, outcome=infected_boston
)
infected_boston_to_nyc = NaturalConversion(
    subject=infected_boston, outcome=infected_nyc
)
recovered_nyc_to_boston = NaturalConversion(
    subject=recovered_nyc, outcome=recovered_boston
)
recovered_boston_to_nyc = NaturalConversion(
    subject=recovered_boston, outcome=recovered_nyc
)
