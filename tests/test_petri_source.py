...
from mira.sources.acsets.petri import state_to_concept, template_model_from_petri_json
...
def test_petri_reverse_parameterized():
    ...
    assert sympy.Float(1.0) == tm.initials['susceptible_population'].expression
